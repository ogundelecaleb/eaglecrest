    ...
    <section className="section-padding bg-blue-900 text-white">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Why Businesses Trust Eagle Crest</h2>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
            <h3 className="text-2xl font-bold mb-6">Our Impact on Society</h3>
            <div className="space-y-6">
              <div>
                <h4 className="font-semibold mb-2">Educational Advancement</h4>
